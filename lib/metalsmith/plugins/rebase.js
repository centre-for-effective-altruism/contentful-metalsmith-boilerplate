...
const debug = require('debug')('rebase-pages')  // DEBUG=rebase-pages
...
module.exports = rebasePages
// require this plugin in ./tasks/metalsmith using:
// const rebasePages = require(paths.lib('metalsmith/plugins/rebase-pages.js'))
